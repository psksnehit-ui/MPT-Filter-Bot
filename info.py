...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/pBmC2QKg/mptjoin.png') # payment code picture url.
PAYMENT_TEXT = environ.get('PAYMENT_TEXT', '<b>Contact Admin</b>')
...
MSG_ALRT = environ.get('MSG_ALRT', '🎬 Welcome to Movie Bot! Search any film.')
